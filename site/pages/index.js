...
export default function Home() {
	...
	const downloadApp = () => {
		...
		if (userAgent.includes("mac")) {
			downloadUrl =
				"https://kodan-videos.s3.us-east-2.amazonaws.com/Neighborhood+1.0.0.dmg";
		} else if (userAgent.includes("win")) {
			downloadUrl =
				"https://kodan-videos.s3.us-east-2.amazonaws.com/Neighborhood-win32-x64.zip";
		} else if (userAgent.includes("linux")) {
			downloadUrl =
				"https://kodan-videos.s3.us-east-2.amazonaws.com/Neighborhood-linux-x64.tar.gz";
		} else {
	...
	return (
		<>
			...
			>
				...
				/>
				<img
					style={{ maxWidth: "100%", marginBottom: 16, width: 400, zIndex: 3 }}
						...
						{!hasSignedUp ? (
							<>
								...
								>
									...
									>
										howdy! If you spend 100 hours coding your own web/mobile app
										this May, you're guaranteed a spot in one of our houses and
										a flight to SF in June!
									</p>
									<div>
										<input
											placeholder="email"
							...
							<>
								...
								>
									<div>
										Welcome to the Neighborhood! Head over to the{" "}
										<a href="https://hackclub.slack.com/archives/C073L9LB4K1">
											#neighborhood
										</a>{" "}
										and meet your future roommates!
									</div>
									{!navigator.userAgent.toLowerCase().includes("mobile") ? (
										...
										>
											Check your email for the app download link for your
											computer :)
										</div>
									)}
								</div>
				...
				{!hasSignedUp && (
					...
					>
						...
						>
							...
							>
								<img src="/info.svg" style={{ height: 32, width: 32 }} />
							</div>
							Info Page
						</button>
					</div>
				...
				>
					...
					>
						<p style={{ fontSize: "24px", fontWeight: "700" }}>
							Thursday, May 1 10:46 AM EST -{" "}
							<b style={{ color: "red" }}>Thomas</b>
						</p>
						<p style={{ transform: "rotate(-0.5deg)", fontSize: 32 }}>
							Today (May 1st), we're launching Neighborhood, our first
							guaranteed housing program. If you ship an app with 100 hours of
							coding (& {"<3"}) put into it, this May, you're guaranteed a
							flight stipend, housing, and food for the Summer in San Francisco.
						</p>
